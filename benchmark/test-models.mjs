...
/**
 * Production prompt — must stay in sync with src/compression/tier3.ts buildCompressionPrompt.
 * test-models.mjs tests use small clean inputs so preprocessing is a no-op here,
 * but the improved rules (rules 3 and 4) still apply.
 */
